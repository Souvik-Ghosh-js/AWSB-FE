...
// Matches the real GET /orders/track response shape exactly (see
// lib/types.ts's Order — a privacy-reduced view, not the full order).
...
export const mockAdminOrderDetail: AdminOrderDetail = {
  ...
  customerId: null,
  adminNote: null,
  shipEmail: 'soumya@example.com',
  shipPhone: '9830012345',
  status: 'confirmed',
  tracking: null,
  shippedAt: null,
  payment: {
